...
function UATDashboard() {
  ...
  const detectObjects = async () => {
    ...
    try {
      ...
      const detections: BoundingBox[] = result.detections.map(
        (det: Detection) => ({
          ...det,
          id: generateId(),
      ...
      if (detections.length === 0) {
        setError(
          "Không phát hiện được object nào. Thử giảm confidence threshold."
        );
      }
    } catch (err) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              Document Layout Analysis System • Version 2.1
            </p>
          </div>
        </div>
        ...
        <aside className="w-80 bg-white border-r border-gray-200 flex flex-col overflow-y-auto shrink-0">
          ...
          <div className="p-5 border-b border-gray-100">
            ...
            >
              ...
              <p className="text-xs text-gray-500">drag/ drop image or click</p>
            </div>

            {imageName && (
              <div className="mt-3 p-2 bg-green-50 border border-green-200 rounded text-sm">
                <p className="text-green-700 truncate font-medium">
                  ✓ {imageName}
                </p>
          ...
          <div className="p-5 border-b border-gray-100">
            ...
            <div className="mb-4">
              ...
              <select className="w-full border-gray-300 border rounded-md py-2 px-3 text-sm bg-white shadow-sm">
                <option>
                  {modelInfo?.model_path || "v2_best.pt"} (Current)
                </option>
          ...
          <div className="p-5 bg-blue-50 flex-1">
            <h3 className="text-xs font-semibold text-blue-800 uppercase tracking-wider mb-4">
              3. Evaluate
            </h3>
                  ...
                  boxes.map((box) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          setSelectedBoxId(
                            box.id === selectedBoxId ? null : box.id
                          )
                        }
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs font-medium ${
                              isLowConfidence ? "text-red-800" : "text-gray-700"
                            }`}
                          >
                            {box.class_name}
                          </span>
